...
(	"RELEASE_INFO" VARCHAR2(2) NOT NULL ENABLE,
     "VER_NAME" VARCHAR2(30),
     "VER" VARCHAR2(10) NOT NULL ENABLE,
     "RELEASE_TIME" DATE,
     "ACTIVE_TIME" DATE,
     "STATE" VARCHAR2(20),
...
CREATE TABLE "FUEL_TYPE_INFO"
   (	"FUEL_TYPE" VARCHAR2(2) NOT NULL ENABLE,
	"FUEL_TYPE_NAME" VARCHAR2(40) NOT NULL ENABLE,
	"P" NUMBER(10,0) NOT NULL ENABLE,
	"P1" NUMBER(10,0) NOT NULL ENABLE,
	"P2" NUMBER(10,0) NOT NULL ENABLE,
	"P3" NUMBER(10,0) NOT NULL ENABLE,
